...
data_path = "C:/Users/PC/Desktop/SSSEP/data"
...
while k < 16: 
    ...
    checkpointer = ModelCheckpoint(filepath='C:/Users/PC/SSSEP/check/checkpoint.h5',
    ...
    #fit the model.
    ###########################################################################
    fittedModel = model.fit(X_train, Y_train, batch_size = 10, epochs = 150, 
                            verbose = 2, validation_data=(X_validate, Y_validate),
                            callbacks=[checkpointer], class_weight = class_weights)
    
    # load optimal weights
    model.load_weights('C:/Users/PC/Desktop/SSSEP/check/checkpoint.h5')
